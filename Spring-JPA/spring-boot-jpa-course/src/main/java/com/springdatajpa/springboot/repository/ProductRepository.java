...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    //  creating query methods from method names
    ...
    /*  creating query's  with @Query annotations   or
    ...
    // in jpql query's  hibernate will create to nativeQuery and then it will execute

    // in Native  query's  hibernate will directly execute the nativeQuery

/*----------------------------------------------------------------------------------*/

    // Define Named JPQL query with index or position parameters

      Product findByPrice1( BigDecimal price);
